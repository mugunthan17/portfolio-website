...
export default function Dock({
  items,
  className = "",
  spring = { mass: 0.1, stiffness: 170, damping: 20 },
  magnification = 70,
  distance = 200,
  panelHeight = 64,
  dockHeight = 256,
  ...
  return (
    ...
    >
      <motion.div
        ...
        className={`${className} absolute bottom-2 left-1/2 transform -translate-x-1/2 flex items-end w-fit gap-4 rounded-2xl border-neutral-700 border-2 pb-2 px-4 backdrop-blur-lg bg-[#060606]/60`}
